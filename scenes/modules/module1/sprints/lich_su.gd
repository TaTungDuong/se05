...
func _on_lich_su_nhan_khau_pressed():
	update_toggle("LichSuNhanKhau")
func _on_lich_su_ho_khau_pressed():
	update_toggle("LichSuHoKhau")
func _on_lich_su_tach_ho_pressed():
	update_toggle("LichSuTachHo")
func _on_lich_su_tam_tru_pressed():
	update_toggle("LichSuTamTru")
func _on_lich_su_tam_vang_pressed():
	update_toggle("LichSuTamVang")
