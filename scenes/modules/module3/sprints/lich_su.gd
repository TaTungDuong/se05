...
func  _ready():
	_on_lich_su_phan_thuong_cuoi_nam_hoc_pressed()
...
func _on_lich_su_phan_thuong_cuoi_nam_hoc_pressed():
	update_toggle("LichSuPhanThuongCuoiNamHoc")
func _on_lich_su_phan_thuong_dip_dac_biet_pressed():
	update_toggle("LichSuPhanThuongDipDacBiet")
